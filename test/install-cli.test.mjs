...
describe('Buzz-first installer CLI', () => {
  ...
  it('writes safe runtime config and invokes bootstrap, daemon, and smoke', async () => {
    ...
    expect(runtime).toContain('BDI_QUERY_GATEWAY_MAX_DKG_CONCURRENT=1');
    expect(runtime).toContain('BDI_QUERY_GATEWAY_MAX_DKG_QUEUE=32');
    expect(runtime).toContain('BDI_QUERY_GATEWAY_CACHE_TTL_MS=120000');
    expect(runtime).toContain('BDI_QUERY_GATEWAY_MAX_CACHE_ENTRIES=256');
